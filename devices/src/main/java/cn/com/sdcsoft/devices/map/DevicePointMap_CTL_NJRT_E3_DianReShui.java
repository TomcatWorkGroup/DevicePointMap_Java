...
public class DevicePointMap_CTL_NJRT_E3_DianReShui extends DevicePointMap {
    ...
    public DevicePointMap_CTL_NJRT_E3_DianReShui() {
        ...
        map.put(SdcSoftDevice.KEY_POINT_RUN_LIFE, ByteField.Init(new BaseInfoField(), SdcSoftDevice.KEY_POINT_RUN_LIFE, 21, 2, "运行时间"));
        ...
        map.put(SdcSoftDevice.KEY_POINT_MEDIA, ByteField.Init(new cn.com.sdcsoft.devices.meta.CTL_NJRT.e3.MediaField(), SdcSoftDevice.KEY_POINT_MEDIA, 0, 0, "介质类型", DevicePointMap.coms_media));
