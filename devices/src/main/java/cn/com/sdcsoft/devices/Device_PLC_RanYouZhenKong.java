...
public class Device_PLC_RanYouZhenKong extends Device_PLC {
    ...
    public List<DeviceFieldForUI> getDeviceFocusFields() {
        ...
        list.add(getUiItem(this.getMockFields(),"mo_remeishuiwendu"));

        list.add(getUiItem(this.getBaseInfoFields(),"ba_shuiweizhuangtai"));
        list.add(getUiItem(this.getMockFields(),"mo_zhenkongyali"));
