...
public class DevicePointMap_PLC_DianReShui extends DevicePointMap {
    ...
    public DevicePointMap_PLC_DianReShui() {
         ...
         * 计算属性（不显示）
         */
        map.put("_addshuibeng", ByteField.Init(new DeviceField(), "_addshuibeng", 0, 0, "补水泵", false));
        ...
        map.put("de_1_addshuibeng_start_stop", ByteField.Init(new DeviceField(), "de_1_addshuibeng_start_stop", 201, 2, "1#补水泵", DevicePointMap.coms_start_stop));
        ...
        map.put("de_2_addshuibeng_start_stop", ByteField.Init(new DeviceField(), "de_2_addshuibeng_start_stop", 205, 2, "2#补水泵", DevicePointMap.coms_start_stop));
        ...
        map.put("de_1_xunhuanbeng_start_stop", ByteField.Init(new DeviceField(), "de_1_xunhuanbeng_start_stop", 211, 2, "1#循环泵", DevicePointMap.coms_start_stop));
        ...
        map.put("de_2_xunhuanbeng_start_stop", ByteField.Init(new DeviceField(), "de_2_xunhuanbeng_start_stop", 215, 2, "2#循环泵", DevicePointMap.coms_start_stop));
