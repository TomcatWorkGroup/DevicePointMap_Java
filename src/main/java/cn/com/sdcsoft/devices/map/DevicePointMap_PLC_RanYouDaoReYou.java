 ...
 * 初始化数据
 */
public class DevicePointMap_PLC_DaoReYou extends DevicePointMap {
    ...
    public DevicePointMap_PLC_DaoReYou() {
        ...
        map.put("ba_xitongzhuangtai", ByteField.Init(new BaseInfoField(), "ba_xitongzhuangtai", 13, 2, "系统状态", coms_status));
        map.put("ba_ranliao", ByteField.Init(new BaseInfoField(), "ba_ranliao", 15, 2, "燃料", coms_power));
        map.put("ba_jiezhimeijie", ByteField.Init(new BaseInfoField(), "ba_jiezhimeijie", 17, 2, "介质", coms_media));
        map.put("ba_shuiweizhuangtai", ByteField.Init(new BaseInfoField(), "ba_shuiweizhuangtai", 19, 2, "水位状态",coms_level));
        map.put("ba_ranshaoqizhuangtai", ByteField.Init(new BaseInfoField(), "ba_ranshaoqizhuangtai", 21, 2, "燃烧器状态",coms_ranshaoqi_status));
        ...
        map.put("de_1#xunhuanbengzidongshoudong", ByteField.Init(new DeviceField(), "de_1#xunhuanbengzidongshoudong", 203, 2, "1#循环泵",coms_atuo));
        map.put("de_1#xunhuanbengqidongtingzhi", ByteField.Init(new DeviceField(), "de_1#xunhuanbengqidongtingzhi", 205, 2, "1#循环泵", coms_start_stop));
        map.put("de_2#xunhuanbengzidongshoudong", ByteField.Init(new DeviceField(), "de_2#xunhuanbengzidongshoudong", 207, 2, "2#循环泵",coms_atuo));
        map.put("de_2#xunhuanbengqidongtingzhi", ByteField.Init(new DeviceField(), "de_2#xunhuanbengqidongtingzhi", 209, 2, "2#循环泵", coms_start_stop));
        map.put("de_3#xunhuanbengzidongshoudong", ByteField.Init(new DeviceField(), "de_3#xunhuanbengzidongshoudong", 211, 2, "3#循环泵",coms_atuo));
        map.put("de_3#xunhuanbengqidongtingzhi", ByteField.Init(new DeviceField(), "de_3#xunhuanbengqidongtingzhi", 213, 2, "3#循环泵",coms_start_stop));
        map.put("de_zhuyoubengzidongshoudong", ByteField.Init(new DeviceField(), "de_zhuyoubengzidongshoudong", 215, 2, "注油泵",coms_atuo));
        map.put("de_zhuyoubengqidongtingzhi", ByteField.Init(new DeviceField(), "de_zhuyoubengqidongtingzhi", 217, 2, "注油泵",coms_start_stop));
