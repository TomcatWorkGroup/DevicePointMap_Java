...
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.BaseInfoField;
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.DeviceField;
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.ExceptionField;
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.MockField;
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.RanShaoQiField;
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.RunDaysField;
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.SettingField;
import cn.com.sdcsoft.devices.meta.CTL_NJZJ.StartStopField;
...
public class DevicePointMap_CTL_NJZJ_IPK2 extends DevicePointMap {
    ...
    public static final String Power = "ba_ranliaoleixing";
    public static final String Media = "ba_jiezhileixing";

    HashMap<Integer, String> coms_level = new HashMap() {{
        put(0, "缺水");
        put(1, "低报警");
        put(2, "低位");
        put(3, "正常");
    ...
    HashMap<Integer, String> coms_device = new HashMap() {{
        put(0xC0, "手");
        put(0x3F, "自");
        put(0x30, "备");
        put(0xCF, "主");
    ...
    public DevicePointMap_CTL_NJZJ_IPK2() {
        ...
        map.put("ba_xitongzhuangtai", ByteField.Init(new BaseInfoField(), "ba_xitongzhuangtai", 20, 1, "系统状态",new HashMap<Integer, String>(){{ put( 0, "关机"); put( 1, "待机"); put( 2, "运行"); put( 3, "报警" );}}));

        map.put("ba_yunxingtianshu", ByteField.Init(new RunDaysField(), "ba_yunxingtianshu", 21, 2, "运行天数","天"));

        map.put("ba_yunxingxiaoshishu", ByteField.Init(new BaseInfoField(), "ba_yunxingxiaoshishu", 23, 1, "运行小时数","时"));

        map.put("ba_ranliaoleixing", ByteField.Init(new BaseInfoField(), "ba_ranliaoleixing", 24, 1, "燃料类型",new HashMap<Integer,String>() {{ put(0, "油气"); put(1, "电"); put(2, "煤"); put(3, "生物质"); }}));

        map.put("ba_jiezhileixing", ByteField.Init(new BaseInfoField(), "ba_jiezhileixing", 25, 1, "介质类型",new HashMap<Integer,String>() {{ put(0, "热水"); put(1, "蒸汽"); put(2, "导热油"); put(3, "热风"); put(4, "真空"); }}));

        map.put("ba_guolushuiweizhuangtai", ByteField.Init(new BaseInfoField(), "ba_guolushuiweizhuangtai", 26, 1, "锅炉液位状态",coms_level));

        map.put("ba_shuixiangshuiweizhuangtai", ByteField.Init(new BaseInfoField(), "ba_shuixiangshuiweizhuangtai", 27, 1, "水箱液位状态",coms_level));

        map.put("ba_guoluyalizhuangtai", ByteField.Init(new BaseInfoField(), "ba_guoluyalizhuangtai", 28, 1, "锅炉压力状态",new HashMap<Integer,String>() {{ put(0, "常压"); put(1, "低压"); put(2, "中压"); put(3, "高压"); put(4, "超压" ); }}));
        map.put("ba_moshibianhao", ByteField.Init(new BaseInfoField(), "ba_moshibianhao", 29, 1, "模式编号"));
        map.put("ba_fangdongkaiguan", ByteField.Init(new BaseInfoField(), "ba_fangdongkaiguan", 30, 1, "防冻开关",new HashMap<Integer, String>(){{ put( 0, "关"); put( 1, "开");}}));
        ...
        map.put("de_ranshaoqi", ByteField.Init(new RanShaoQiField(), "de_ranshaoqi", 681, 2, "燃烧器",new HashMap<Integer,String>() {{ put(0, "停"); put(1, "小火"); put(2, "大火"); }}));

        map.put("de_jiarezu", ByteField.Init(new DeviceField(), "de_jiarezu", 683, 2, "加热组",coms_device));

        map.put("de_bushuibeng", ByteField.Init(new DeviceField(), "de_bushuibeng", 685, 2, "补水泵",coms_device));

        map.put("de_jishuibeng", ByteField.Init(new DeviceField(), "de_jishuibeng", 687, 2, "给水泵",coms_device));

        map.put("de_buyoubeng", ByteField.Init(new DeviceField(), "de_buyoubeng", 689, 2, "补油泵",coms_device));

        map.put("de_xunhuanbeng", ByteField.Init(new DeviceField(), "de_xunhuanbeng", 691, 2, "循环泵",coms_device));

        map.put("de_lengningbeng", ByteField.Init(new DeviceField(), "de_lengningbeng", 693, 2, "冷凝泵",coms_device));

        map.put("de_reshuibeng", ByteField.Init(new DeviceField(), "de_reshuibeng", 695, 2, "热水泵",coms_device));

        map.put("de_zhenkongbeng", ByteField.Init(new DeviceField(), "de_zhenkongbeng", 697, 2, "真空泵",coms_device));

        map.put("de_ecixunhuanbeng", ByteField.Init(new DeviceField(), "de_ecixunhuanbeng", 699, 2, "二次循环泵",coms_device));

        map.put("de_yinfengji", ByteField.Init(new DeviceField(), "de_yinfengji", 701, 2, "引风机",coms_device));

        map.put("de_gufengji", ByteField.Init(new DeviceField(), "de_gufengji", 703, 2, "鼓风机",coms_device));

        map.put("de_lupai", ByteField.Init(new DeviceField(), "de_lupai", 705, 2, "炉排",coms_device));

        map.put("de_chuzhaji", ByteField.Init(new DeviceField(), "de_chuzhaji", 707, 2, "出渣机",coms_device));

        map.put("de_ecigufengji", ByteField.Init(new DeviceField(), "de_ecigufengji", 709, 2, "二次鼓风机",coms_device));

        map.put("de_dianhuoqi", ByteField.Init(new DeviceField(), "de_dianhuoqi", 711, 2, "点火器",coms_device));

        map.put("de_shangmeiji", ByteField.Init(new DeviceField(), "de_shangmeiji", 713, 2, "上煤机",coms_device));

        map.put("de_songliaoji", ByteField.Init(new DeviceField(), "de_songliaoji", 715, 2, "送料机",coms_device));

        map.put("de_jiayaobeng", ByteField.Init(new DeviceField(), "de_jiayaobeng", 717, 2, "加药泵",coms_device));

        map.put("de_paiwufa", ByteField.Init(new DeviceField(), "de_paiwufa", 719, 2, "排污阀",coms_device));

        map.put("de_huilu1xunhuanbeng", ByteField.Init(new DeviceField(), "de_huilu1xunhuanbeng", 721, 2, "回路1循环泵",coms_device));

        map.put("de_huilu2xunhuanbeng", ByteField.Init(new DeviceField(), "de_huilu2xunhuanbeng", 723, 2, "回路2循环泵",coms_device));

        map.put("de_huilu3xunhuanbeng", ByteField.Init(new DeviceField(), "de_huilu3xunhuanbeng", 725, 2, "回路3循环泵",coms_device));

        map.put("de_huilu4xunhuanbeng", ByteField.Init(new DeviceField(), "de_huilu4xunhuanbeng", 727, 2, "回路4循环泵",coms_device));

        map.put("de_huilu5xunhuanbeng", ByteField.Init(new DeviceField(), "de_huilu5xunhuanbeng", 729, 2, "回路5循环泵",coms_device));
